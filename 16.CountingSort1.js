...
function countingSort(arr) {
  let freq = new Array(100).fill(0); // Initialize an array with 100 elements and fill it with 0s

  for (let i = 0; i < arr.length; i++) {
    freq[arr[i]]++; // Increment the count at index arr[i] in the frequency array
  }
